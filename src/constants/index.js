...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Developed and maintained a Dart SDK using Method Channels to execute native code and access platform-specific APIs, providing a consistent cross-platform interface across Android, iOS, and Windows.",
      "Implemented Android Intent-based APIs enabling third-party apps to trigger direct print passthrough (raw/line-print commands) and query real-time printer status without launching the Zebra Print app.",
      "Built the PrintConnect dashboard and cloud storage integration for the Zebra Print Android app, featuring printer provisioning, Box/Dropbox OAuth login, and offline file caching.",
      "Implemented comprehensive Unit Testing for Flutter and native bridges, achieving 85% code coverage and improving overall app stability.",
      ...
      "Authored a custom Claude Code plugin with Skills and MCP integrations (Jira, Confluence, GitHub), including a Skill that decomposes initiatives into structured Epics and Epics into Stories, reducing story-writing errors and PM rework by 35–40%.",
      "Developed an AI agent for automated release notes, triggered on production merges, correlating GitHub commit history with linked Jira stories via MCP to publish structured release summaries without manual effort.",
      "Implemented RAG pipelines using Vector Stores and function-calling for context retrieval and precise data processing across custom AI agents and Next.js web interfaces.",
    ],
  },
  {
    ...
    points: [
      ...
      "Guiding and mentoring an intern on the GenAI/agent workstream, pairing on the Google Cloud Monitoring (formerly Stackdriver) integration, sprint-planning agent, and Claude Code plugin work to ramp them up on MCP and function-calling design patterns in LLMs.",
    ],
  },
];
